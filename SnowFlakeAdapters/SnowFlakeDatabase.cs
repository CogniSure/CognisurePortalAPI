...
namespace SnowFlakeAdapter
{
    public class SnowFlakeDatabase: ISnowFlakeDatabase
    {
        ...
        {
            return BaseDatabase.GetData("call SP_SubCountByLOB('" + clientId + "', '" + UserEmailId + "', '" + startDate.ToString("MM/dd/yyyy") + "','" + EndDate.ToString("MM/dd/yyyy") + "'); ");
        }
        ...
        {
            return BaseDatabase.GetData("call SP_SubCountByByBroker('" + TopNumber + "','" + clientId + "', '" + UserEmailId + "', '" + startDate.ToString("MM/dd/yyyy") + "',  '" + EndDate.ToString("MM/dd/yyyy") + "');");
        }
        ...
        {
            return BaseDatabase.GetData("call SP_SubCountByCity('" + TopNumber + "','" + clientId + "','" + UserEmailId + "', '" + startDate.ToString("MM/dd/yyyy") + "',  '" + EndDate.ToString("MM/dd/yyyy") + "');");
        }
        ...
        {
            return BaseDatabase.GetData("call SP_SubCountByState('" + TopNumber + "','" + clientId + "', '" + UserEmailId + "', '" + startDate.ToString("MM/dd/yyyy") + "',  '" + EndDate.ToString("MM/dd/yyyy") + "');");
        }
        ...
        {
            return BaseDatabase.GetData("call SP_SubCountByIndustries('" + TopNumber + "','" + clientId + "', '" + UserEmailId + "', '" + startDate.ToString("MM/dd/yyyy") + "',  '" + EndDate.ToString("MM/dd/yyyy") + "');");
        }
    }
}
